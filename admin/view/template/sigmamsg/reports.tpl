            ...
            <div class="col-lg-12 col-md-12 col-xs-12 sending_history__body">
                <div class=" col-lg-4 col-md-12 col-xs-12" style=" display: none; margin-bottom: 40px;padding-left: 0;" >
                    ...
                    <div class="col-sm-12 sending__report">
                       ...
                       <div>
                            <div class="report_sending_title">
                                <strong class="sending_channel_title" style=" text-align: left; width: 30%;">Канал отправки</strong>
                                <strong class="count_msg_title" style="width: 40%;">Количество сообщений</strong>
                                <strong class="summ_title" >Сумма</strong>
                            </div>
                            <div class="report_sending_item sms_item" style="display: flex;">
                            ...
                            <div class="report_sending_item voice_item" style="display: flex;">
                                <label class="service-label voice_label">
                                    <svg width="22" height="22" class="voice_ico" viewBox="0 0 20 20" fill="none">
                                        <rect x="-1" y="1" width="18" height="18" rx="9"
                                              ...
                                              stroke="#828282" stroke-width="2"></rect>
                                        ...
                                        <path d="M12.3999 7.6001L12.3999 13.2001" stroke="#828282" stroke-width="2"
                                              stroke-miterlimit="22.9256" stroke-linecap="round"
                                              stroke-linejoin="round"></path>
                                        <path d="M15.2 9.2002V11.6002" stroke-width="2" stroke-miterlimit="22.9256"
                            ...
                            <div class="report_sending_item  viber_item" style="display: flex;">
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 sending_history__table">
                    <h3>Детальный отчет:</h3>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col" class="type" >Тип</th>
                                <th scope="col" class="status" >Статус</th>
                                <th scope="col" class="recipient" >Получатель</th>
                                <th scope="col" class="sender" >Отправитель</th>
                                <th scope="col" class="text" >Текст</th>
                                <th scope="col" class="price">Цена</th>
                                <th scope="col" class="created_at">Создано</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="preloader_row" >
                                <td>
                                    <div class="preloader">
                                        <div></div>
                                        <div></div>
